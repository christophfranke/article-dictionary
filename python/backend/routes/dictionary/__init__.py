...
from .get import get_word


dictionary = Blueprint('dictionary', __name__)

dictionary.route('/', methods=['GET'])(list_words)
dictionary.route('/get/<id>', methods=['GET'])(get_word)
...
dictionary.route('/<original>', methods=['GET'])(get_detail)
